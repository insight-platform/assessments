...
* [a configuration](detector/src/detector/config.py)

  The configration defines the restricted time and other parameters (if required).
* [detection data producer](detector/src/detector/data.py)
...
* [detector](detector/src/detector/detector.py)

  The detector receives data from the queue and analyzes it.
* [alert manager](detector/src/detector/alert.py)
